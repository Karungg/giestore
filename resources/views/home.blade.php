...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <header class="border-b border-palette-lighter sticky top-0 z-20 bg-white">
        <div class="flex items-center justify-between mx-auto max-w-6xl px-6 pb-2 pt-4 md:pt-6"><a
                ...
                <h1 class="flex no-underline"><img height="32" width="32" alt="logo"
                        ...
                        class="text-2xl font-primary text-secondary font-bold tracking-tight pt-1">Giestore</span></h1>
            </a>
        </div>
    </header>
